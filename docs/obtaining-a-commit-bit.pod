...
colloquial way that [#perl6](https://webchat.freenode.net/?channels=#perl6)
...
Some contributors chose to email the CLA to `trademark -at- perlfoundation.org`
instead; you can speak to `[Coke]` on
[our IRC chat](https://webchat.freenode.net/?channels=#perl6) for details about
...
**Once you send off your signed CLA,** and it's received by The Perl Foundation
you can then inquire on
[irc://freenode.net/#perl6](https://webchat.freenode.net/?channels=#perl6)
