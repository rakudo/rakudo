...
Use the C<./github-release> script to create NQP and Rakudo Github releases.
Refer to MoarVM release guide for the details about artifacts attachment.

The script will look like it failed, but this is due to the artifacts upload; verify that the release
...
In the UI, copy the announce into the github release description field for Rakudo.
