...
some releases to ensure any compatibility issues are resolved.
  ...
  2021-07-23   Rakudo #148 (Altai-man + Releasable)
...
Create a signature and checksum files:

    gpg --detach-sign --armor rakudo-YYYY.MM.tar.gz

    md5sum    --tag rakudo-YYYY.MM.tar.gz >> rakudo-YYYY.MM.tar.gz.checksums.txt
    sha1sum   --tag rakudo-YYYY.MM.tar.gz >> rakudo-YYYY.MM.tar.gz.checksums.txt
    sha224sum --tag rakudo-YYYY.MM.tar.gz >> rakudo-YYYY.MM.tar.gz.checksums.txt
    sha256sum --tag rakudo-YYYY.MM.tar.gz >> rakudo-YYYY.MM.tar.gz.checksums.txt
    sha384sum --tag rakudo-YYYY.MM.tar.gz >> rakudo-YYYY.MM.tar.gz.checksums.txt
    sha512sum --tag rakudo-YYYY.MM.tar.gz >> rakudo-YYYY.MM.tar.gz.checksums.txt

    gpg --clearsign rakudo-YYYY.MM.tar.gz.checksums.txt
