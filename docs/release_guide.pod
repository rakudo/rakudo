...
some releases to ensure any compatibility issues are resolved.
  ...
  2021-11-19   Rakudo #152 (Be the next release manager!)
...
If you do not have permissions for that, ask one of ([Coke], jnthn, lizmat,
moritz, rba, sena_kun, timo) on #raku or #raku-dev to do it for you.
