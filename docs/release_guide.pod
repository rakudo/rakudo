...
=head2 Planned future releases
  ...
  2016-01-16   Rakudo #95  - Coke

Note that #95 will be the first release that has to cope with
backward compatibility issues. As such, we may end up delaying
this release to insure any compatibility issues are resolved.
