...
L<docs/release_guide_automated.md|https://github.com/rakudo/rakudo/blob/master/docs/release_guide_automated.md> >>
...
some releases to ensure any compatibility issues are resolved.
  ...
  2018-01-20   Rakudo #119 (AlexDaniel + Releasable)
