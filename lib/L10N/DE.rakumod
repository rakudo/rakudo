...
#- Generated on 2023-10-13T20:10:29+02:00 by tools/build/makeL10N.raku
...
role L10N::DE {
    ...
    method trait-is2ast {
        my constant %mapping = "kopie", "copy", "standard", "default", "VERALTET", "DEPRECATED", "äquivalent", "equiv", "implementierungsdetail", "implementation-detail", "lockerer", "looser", "rein", "pure", "roh", "raw", "nur-lesen", "readonly", "lesen-schreiben", "rw", "enger", "tighter";
        my $ast := self.ast();
        if %mapping{$ast.simple-identifier()} -> $original {
            RakuAST::Name.from-identifier($original)
        }
