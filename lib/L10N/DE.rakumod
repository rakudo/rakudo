...
role L10N::DE {
    ...
    method adverb-pc2str (str $key) {
        my constant %mapping = "entferne", "delete", "existiert", "exists", "s", "k", "sw", "kv", "w", "v";
        %mapping{$key} // $key
    }
