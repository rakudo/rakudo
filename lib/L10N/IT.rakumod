...
#- Generated on 2023-10-07T11:40:29+02:00 by tools/build/makeL10N.raku
...
role L10N::IT {
    ...
    token use-use { usare}
    method xlated2ast {
        my constant %core = "abs", "abs", "tutti", "all", "ogni", "any", "aggiungi", "append", "ast", "ast", "atomic-add-fetch", "atomic-add-fetch", "atomic-assign", "atomic-assign", "atomic-dec-fetch", "atomic-dec-fetch", "atomic-fetch", "atomic-fetch", "atomic-fetch-add", "atomic-fetch-add", "atomic-fetch-dec", "atomic-fetch-dec", "atomic-fetch-inc", "atomic-fetch-inc", "atomic-fetch-sub", "atomic-fetch-sub", "atomic-inc-fetch", "atomic-inc-fetch", "atomic-sub-fetch", "atomic-sub-fetch", "aspetta", "await", "borsa", "bag", "callframe", "callframe", "callsame", "callsame", "callwith", "callwith", "cas", "cas", "categorizzare", "categorize", "soffitto", "ceiling", "chars", "chars", "chdir", "chdir", "chmod", "chmod", "chomp", "chomp", "chop", "chop", "chown", "chown", "chr", "chr", "chrs", "chrs", "classificare", "classify", "chide", "close", "pettine", "comb", "combinazioni", "combinations", "mappa-profonda", "deepmap", "definito", "defined", "muori", "die", "dir", "dir", "fatto", "done", "mappa-anatra", "duckmap", "elems", "elems", "emettere", "emit", "fine", "end", "uscire", "exit", "exp", "exp", "expmod", "expmod", "fallire", "fail", "fc", "fc", "primo", "first", "piatto", "flat", "flip", "flip", "pavimento", "floor", "barriera-completa", "full-barrier", "prendi", "get", "getc", "getc", "essenza", "gist", "grep", "grep", "hash", "hash", "testa", "head", "indenta", "indent", "indice", "index", "indici", "indices", "indir", "indir", "articolo", "item", "unirsi", "join", "chiave", "key", "chiavi", "keys", "cv", "kv", "ultimo", "last", "ultima-chiamata", "lastcall", "lc", "lc", "linee", "lines", "link", "link", "elenco", "list", "lsb", "lsb", "fare", "make", "mappa", "map", "max", "max", "min", "min", "minmax", "minmax", "mix", "mix", "mkdir", "mkdir", "muove", "move", "msb", "msb", "prossimo", "next", "prossimo-chiamato", "nextcallee", "prossimo-esteso", "nextsame", "prossimo-con", "nextwith", "nessuno", "none", "non", "not", "nota", "note", "uno", "one", "aperto", "open", "ord", "ord", "ords", "ords", "paio", "pair", "pai", "pairs", "parse-base", "parse-base", "permutazioni", "permutations", "prendi", "pick", "pop", "pop", "prepend", "prepend", "stampa", "print", "f-stampa", "printf", "procedi", "proceed", "richiesta", "prompt", "spinge", "push", "metti", "put", "rand", "rand", "rifai", "redo", "riduci", "reduce", "ripetuto", "repeated", "repl", "repl", "restituisci", "return", "return-rw", "return-rw", "reverse", "reverse", "rindex", "rindex", "rmdir", "rmdir", "roll", "roll", "rotate", "rotate", "round", "round", "roundrobin", "roundrobin", "run", "run", "stesso-caso", "samecase", "stessa-marca", "samemark", "stessa-con", "samewith", "dillo", "say", "set", "set", "shell", "shell", "sposta", "shift", "firma", "sign", "segno", "signal", "salta", "skip", "dormi", "sleep", "sleep-timer", "sleep-timer", "dormi-fino-a", "sleep-until", "scivola", "slip", "bevi", "slurp", "taglia", "snip", "fail-la-spia", "snitch", "così", "so", "ordina", "sort", "unisci", "splice", "divitevi", "split", "sprintf", "sprintf", "spruzza", "spurt", "sqrt", "sqrt", "schiaccia", "squish", "srand", "srand", "subbuf", "subbuf", "subbuf-rw", "subbuf-rw", "riuscirci", "succeed", "somma", "sum", "symlink", "symlink", "coda", "tail", "prendi", "take", "prendi-rw", "take-rw", "tc", "tc", "tclc", "tclc", "taglia", "trim", "taglia-in-testa", "trim-leading", "taglia-in-coda", "trim-trailing", "troncare", "truncate", "uc", "uc", "unimatch", "unimatch", "uniname", "uniname", "uninames", "uninames", "uniparse", "uniparse", "uniprop", "uniprop", "uniprops", "uniprops", "unique", "unique", "unival", "unival", "univals", "univals", "unlink", "unlink", "unshift", "unshift", "val", "val", "valore", "value", "valori", "values", "avviso", "warn", "caso-della-parola", "wordcase", "parole", "words";
        my $ast := self.ast();
