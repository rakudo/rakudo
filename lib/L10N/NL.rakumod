...
role L10N::NL {
    ...
    method trait-is2ast {
        my constant %mapping = "kopie", "copy", "verstek", "default", "VEROUDERD", "DEPRECATED", "equivalent", "equiv", "implementatie-detail", "implementation-detail", "losser", "looser", "puur", "pure", "rauw", "raw", "alleen-lezen", "readonly", "lezen-schrijven", "rw", "strakker", "tighter";
        my $ast := self.ast();
        if %mapping{$ast.simple-identifier()} -> $original {
            RakuAST::Name.from-identifier($original)
        }
