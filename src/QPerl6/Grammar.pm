...
grammar QPerl6::Grammar is HLL::Grammar {
    method TOP() {
        # Language braid.
        my %*LANG;
        %*LANG<Regex>         := QPerl6::RegexGrammar;
        %*LANG<Regex-actions> := QPerl6::RegexActions;
        %*LANG<MAIN>          := QPerl6::Grammar;
        %*LANG<MAIN-actions>  := QPerl6::Actions;
        ...
        my $*W := nqp::isnull($file) ??
            QPerl6::World.new(:handle($source_id)) !!
            QPerl6::World.new(:handle($source_id), :description($file));
    ...
    token attach_docs {
        {
            if ~$*DOC ne '' {
                my $cont  := QPerl6::Pod::serialize_aos(
                    [QPerl6::Pod::formatted_text(~$*DOC)]
                )<compile_time_value>;
    ...
    INIT {
        QPerl6::Grammar.O(':prec<y=>, :assoc<unary>', '%methodcall');
        QPerl6::Grammar.O(':prec<x=>, :assoc<unary>', '%autoincrement');
        QPerl6::Grammar.O(':prec<w=>, :assoc<right>', '%exponentiation');
        QPerl6::Grammar.O(':prec<v=>, :assoc<unary>', '%symbolic_unary');
        QPerl6::Grammar.O(':prec<u=>, :assoc<left>',  '%multiplicative');
        QPerl6::Grammar.O(':prec<t=>, :assoc<left>',  '%additive');
        QPerl6::Grammar.O(':prec<s=>, :assoc<left>',  '%replication');
        QPerl6::Grammar.O(':prec<r=>, :assoc<left>',  '%concatenation');
        QPerl6::Grammar.O(':prec<q=>, :assoc<list>', '%junctive_and');
        QPerl6::Grammar.O(':prec<p=>, :assoc<list>', '%junctive_or');
        QPerl6::Grammar.O(':prec<o=>, :assoc<unary>', '%named_unary');
        QPerl6::Grammar.O(':prec<n=>, :assoc<left>',  '%structural');
        QPerl6::Grammar.O(':prec<m=>, :assoc<left>, :iffy<1>, :pasttype<chain>',  '%chaining');
        QPerl6::Grammar.O(':prec<l=>, :assoc<left>',  '%tight_and');
        QPerl6::Grammar.O(':prec<k=>, :assoc<list>',  '%tight_or');
        QPerl6::Grammar.O(':prec<j=>, :assoc<right>', '%conditional');
        QPerl6::Grammar.O(':prec<i=>, :assoc<right>', '%item_assignment');
        QPerl6::Grammar.O(':prec<i=>, :assoc<right>, :sub<e=>', '%list_assignment');
        QPerl6::Grammar.O(':prec<h=>, :assoc<unary>', '%loose_unary');
        QPerl6::Grammar.O(':prec<g=>, :assoc<list>, :nextterm<nulltermish>',  '%comma');
        QPerl6::Grammar.O(':prec<f=>, :assoc<list>',  '%list_infix');
        QPerl6::Grammar.O(':prec<e=>, :assoc<right>', '%list_prefix');
        QPerl6::Grammar.O(':prec<d=>, :assoc<left>',  '%loose_and');
        QPerl6::Grammar.O(':prec<c=>, :assoc<list>',  '%loose_or');
        QPerl6::Grammar.O(':prec<b=>, :assoc<list>',  '%sequencer');
    }
...
grammar QPerl6::RegexGrammar is QRegex::P6Regex::Grammar {
