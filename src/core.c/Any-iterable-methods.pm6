...
augment class Any {
    ...
    my class IterateTwoWithoutPhasers does Rakudo::SlippyIterator {
        ...
        # Handle case where odd number of values where generated by the
        # iterator, when 2 values are expected to be passed.
        method !no-b(Mu $a) is raw {
            nqp::stmts(
              nqp::handle(
                nqp::stmts(
                  ($!source := Rakudo::Iterator.Empty),
        ...
        method pull-one() is raw {
            ...
            nqp::while(
              ...
              nqp::if(
                ...
                ($value := self!no-b($a)),  # iterator exhausted
