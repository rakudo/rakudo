...
Perhaps it can be found at https://docs.perl6.org/type/$name"
    ...
    multi method BUILDALL(%attrinit) {
        ...
        nqp::while(
          ...
          nqp::if(
            nqp::islist(my $task := nqp::atpos($bp,$i)),
            nqp::if(                             # got stuff to do
                  ...
                  nqp::if(                         # > 2
                    ...
                    nqp::if(                       # > 3
                      ...
                      nqp::unless(                   # 4
                        ...
                        nqp::getattr(self,             # not initialized yet
                          nqp::atpos($task,1),
                          nqp::atpos($task,2)
                      ...
                      nqp::if(                     # > 4
                        ...
                        nqp::if(                     # 5
                          ...
                          nqp::bindattr_i(self,        # not initialized yet
                            nqp::atpos($task,1),
                            nqp::atpos($task,2),
                        ...
                        nqp::if(                   # > 5
                          ...
                          nqp::if(                   # 6
                            ...
                            nqp::bindattr_n(self,      # not initialized yet
                              nqp::atpos($task,1),
                              nqp::atpos($task,2),
                          ...
                          nqp::if(                 # > 6
                            ...
                            nqp::if(                 # 7
                              ...
                              nqp::bindattr_s(self,    # not initialized yet
                                nqp::atpos($task,1),
                                nqp::atpos($task,2),
                            ...
                            nqp::if(               # > 7
                              ...
                              nqp::unless(           # 8
                                ...
                                X::Attribute::Required.new(  # missing init
              ...
              nqp::if(                             # 0
                ...
                nqp::if(                             # no init
                  nqp::iseq_i(nqp::elems($task),5),
                  nqp::unless(                         # but has default
                    nqp::attrinited(self,
                      nqp::atpos($task,1),
                      nqp::atpos($task,2)
                    ),
                    nqp::getattr(self,                   # didn't init yet
                      nqp::atpos($task,1),
                      nqp::atpos($task,2)
                          ...
                          nqp::if(                 # > 6
                            ...
                            nqp::if(               # > 7
                              ...
                              nqp::if(             # > 8
                                ...
                                nqp::if(           # > 9
                                  nqp::iseq_i($code,10),
# Force vivification, for the sake of meta-object mix-ins at compile time
# ending up with correctly shared containers.
                                  nqp::stmts(      # 10
                                    nqp::getattr(self,
                                      nqp::atpos($task,1),
                                      nqp::atpos($task,2)
