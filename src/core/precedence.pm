...
BEGIN {
    ...
    trait_mod:<is>(&infix:<(elem)>,     :prec($iffy));
#    trait_mod:<is>(&infix:<<"\x2208">>, :prec($iffy));
#    trait_mod:<is>(&infix:<<"\x2209">>, :prec($iffy));
    trait_mod:<is>(&infix:<(cont)>,     :prec($iffy));
#    trait_mod:<is>(&infix:<<"\x220B">>, :prec($iffy));
#    trait_mod:<is>(&infix:<<"\x220C">>, :prec($iffy));
#    trait_mod:<is>(&infix:<<(<)>>,      :prec($iffy));
#    trait_mod:<is>(&infix:<<"\x2282">>, :prec($iffy));
#    trait_mod:<is>(&infix:<<"\x2284">>, :prec($iffy));
#    trait_mod:<is>(&infix:<<(>)>>,      :prec($iffy));
#    trait_mod:<is>(&infix:<<"\x2283">>, :prec($iffy));
#    trait_mod:<is>(&infix:<<"\x2285">>, :prec($iffy));
#    trait_mod:<is>(&infix:<<(<=)>>,     :prec($iffy));
#    trait_mod:<is>(&infix:<<"\x2286">>, :prec($iffy));
#    trait_mod:<is>(&infix:<<"\x2288">>, :prec($iffy));
#    trait_mod:<is>(&infix:<<(>=)>>,     :prec($iffy));
#    trait_mod:<is>(&infix:<<"\x2287">>, :prec($iffy));
#    trait_mod:<is>(&infix:<<"\x2289">>, :prec($iffy));
