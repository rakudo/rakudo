...
# Check ways to create the T:I:Thread instrument
for 'Thread', Telemetry::Instrument::Thread -> \instrument {
    ...
    is @instruments[0], Telemetry::Instrument::Thread,
...
# Assume T:I:Thread is only instrument from now on
my $snap1 = $instrument.snap;
my $snap-class = $snap1.WHAT;
isa-ok $snap-class, Telemetry::Instrument::Thread::Snap;
