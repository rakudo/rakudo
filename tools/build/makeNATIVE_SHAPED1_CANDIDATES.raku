...
multi sub postcircumfix:<[ ]>(
  array::shaped1#type#array \SELF, int $pos, :$kv!
--> Bool:D) is raw {
    $kv
...
multi sub postcircumfix:<[ ]>(
  array::shaped1#type#array \SELF, int $pos, :$p!
--> Bool:D) is raw {
    $p
...
multi sub postcircumfix:<[ ]>(
  array::shaped1#type#array \SELF, int $pos, :$k!
--> Bool:D) is raw {
...
multi sub postcircumfix:<[ ]>(
  array::shaped1#type#array \SELF, int $pos, :$v!
--> Bool:D) is raw {
    $v
